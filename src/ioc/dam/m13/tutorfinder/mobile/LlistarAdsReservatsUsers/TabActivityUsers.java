...
public class TabActivityUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPageAdapter.addFragment(new FragmentAdsBookedByUser(), "Reserves de l'usuari");
        viewPageAdapter.addFragment(new FragmentAdsBookedByOthers(), "Solicituds d'altres");
